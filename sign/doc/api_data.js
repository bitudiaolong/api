define({ "api": [
      ...
      "fields": {
        "功能请求参数": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "signState",
            "description": "<p>签约状态（0待签约 1已签约 2已解约 9已过期 11 待审核 12 待确认 13 已驳回）</p>"
          },
          {
            "group": "功能请求参数",
            "type": "String",
      ...
      "fields": {
        ...
        "list列表内元素对象属性": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "signState",
            "description": "<p>当前签约状态（0待签约 1已签约 2已解约 9已过期 11 待审核 12 待确认 13 已驳回）</p>"
          },
          {
            "group": "list列表内元素对象属性",
            "type": "String",
  ...
  },
  {
    ...
    "group": "F__privateWork_api_sign_doc_main_js",
    "groupTitle": "F__privateWork_api_sign_doc_main_js",
    "name": ""
  }
] });
